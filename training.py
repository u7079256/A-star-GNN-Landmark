...
class GAT(torch.nn.Module):
    def __init__(self):
        ...
        self.conv1 = GATConv(1, self.hid, heads=self.in_head, dropout=0.5, edge_dim=1)
        self.conv2 = GATConv(self.hid * self.in_head, 3, concat=False,
                             heads=self.out_head, dropout=0.5, edge_dim=1)
...
dataset = RoadNetworkDataset(root="data/", raw_dir='testing', pre_transform=T.OneHotDegree)
